                ...
                <table class="table display table-bordered table-striped table-hover multi-tables dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->code }}</td>
                            <td>{{ $item->point }}</td>
                            <td><a href="{{ URL::to('/').$item->url }}" target="_blank">{{ URL::to('/').$item->url
                                    }}</a></td>
                            <td>{{ $item->status }}</td>
                            <td>
                            ...
                            <td>
                                ...
                                $p= URL::to('/').$item->url;
                                @endphp
                                {!!Share::page($p)->facebook()->twitter()->whatsapp();!!}
                            </td>
                            <td>
                                <a class="btn btn-success-soft btn-sm mr-1" href="{{ route('editUser', $item->id) }}"
